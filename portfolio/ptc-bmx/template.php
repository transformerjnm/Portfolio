...
<body class="grey lighten-4">
	<header>
		...
		<div class="navbar-fixed">
			<nav class=" maincolor z-depth-4 ">
				<div class="nav-wrapper">
					...
					<!-- Make current page have class active  **************************************************************************** -->
					<ul class="flow-text hide-on-med-and-down">
						<li class="bold active"><a href="index.php">Home</a></li>
		...
		<div class="row secondarycolor section marginzero">
			<div class="col s12">
				<h3 class="bold center">Template</h3>
			</div>
		</div>
	</header>
	<main>
		<!-- empty text card template -->
		<!--
...
-->
		...
		<!-- Add spsonors by copying adn pasting below code to the bottom of the list.
			
			<div class="col s12 m6 l2 xl1 center-align">
				<a href="link the sponor website here" target="_blank"><img class="responsive-img sponsimg" src="images/imgname.jpg" alt="description of img for screen readers."></a>
			</div>
			
			Save you transparent sponsor logo Image inside of the images folder.
			Once you add the code to the list then addjust the Materlized CSS grid to fit then new content. Dont know how to do that? Check out the documentation of the website or the offical documentation of it at
			https://materializecss.com/grid.html 
			Still confused? search a youtube video of Materlized CSS Grid.
			
			PS. Dont forget to copy your new sponsor list and paste it to all Pages. So that they are all up to date. IF you have more then twelve sponsors you will need to make a second row of sponsors.
